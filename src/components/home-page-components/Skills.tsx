...
export function SkillCard({ name, icon }: SkillCardProps) {
  return (
    <div className="flex flex-col items-center group">
      <div className="dark:bg-[#1a1528] bg-slate-100 rounded-lg mb-4 w-32 h-32 flex items-center justify-center transition-transform hover:scale-105">
        <img
      ...
      <div className="text-violet-400">{name}</div>
    </div>
  );
}
...
const Skills = () => {
  return (
    <section className="w-full dark:bg-slate-900 bg-slate-50 py-16 px-4 md:px-6 lg:px-8">
