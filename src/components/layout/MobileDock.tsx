...
import { Home, Briefcase, Layers, Images, MessageSquare, Send } from 'lucide-react';
import { useCallback, useMemo } from 'react';

type SectionId = 'home' | 'services' | 'experience' | 'portfolio' | 'testimonial' | 'contact';
  ...
  const items = useMemo(
    () => [
      ...
      },
      {
        ...
        label: 'Experience',
        onClick: () => scrollToSection('experience' as SectionId)
      },
      {
        key: 'portfolio',
